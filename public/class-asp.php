...
class AcceptStripePayments {
	 ...
	 * @var      string
	 */
	protected $plugin_slug = 'accept_stripe_payment';
	...
	private static function single_activate() {
	    ...
	    $alreadyInstalled =get_option('AcceptStripePayments-settings');
	    if(empty($alreadyInstalled)){
            ...
            if ($checkout_page_id == '') {
                $checkout_page_id = AcceptStripePayments::create_post('page', 'Checkout', 'AcceptStripePayments-checkout', '[accept_stripe_payment_checkout]');
